...
-- Create backfill_processor_status table for tracking processor status
CREATE TABLE IF NOT EXISTS backfill_processor_status (
    backfill_alias VARCHAR(50) NOT NULL PRIMARY KEY,
...
-- Create indexes for efficient queries (using IF NOT EXISTS for indexes)
